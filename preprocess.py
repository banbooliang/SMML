...
src_path = '../m3ae-main/MICCAI_BraTS_2020_Data_Training/'
tar_path = './BRATS2020_Training_none_npy_n'
...
for file_name in name_list:
    ...
    print(os.path.join(src_path, file_name, case_id+'_flair.nii.gz'))
    ...
    seg1[seg1==4]=3
    # medio.save(vol1, os.path.join(tar_path, 'vol', case_id+'_vol.nii.gz'))
    # medio.save(seg1, os.path.join(tar_path, 'seg', case_id+'_seg.nii.gz'))
